...
Hosting : build sur `0ea7fb9`, bundle `index-DAVpr6jE.js`, 554 fichiers, 71 nouveaux. Recette anonyme à 390 × 844 sur la production (navigateur intégré, 16 septembre 02 h 30) : démo `#value` — `scrollWidth` 390 = `clientWidth`, `lang="fr"`, barre 69 px, onglet « 04 Valorisation » visible (146-244, piste 676/390 à `scrollLeft` 246), onglets « 00 Accueil » / « 01 Médias » / « 02 La référence », 0 cible < 44 px dans la barre, un seul `h1` (« Valorisation »), graphique `role="group"` focalisable 378 px dans une carte de 348, 0 bascule de langue ; démo `#cover` — 390/390, `h1` unique « Rolex Submariner », barre 69, aucun « mini -site » ; accueil — 390/390, `h1` à 174 px, 38 cibles dont 5 < 44 px, toutes des liens en phrase (`display: inline`, exemption WCAG 2.5.8). Recette téléphone réel (Safari iOS, Chrome Android : Cartulaire propriétaire en édition, Registre en session, libellés à 9 px de la barre supérieure, D18) : Jérôme.
