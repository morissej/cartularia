...
| B6 | Avertissements console « Deprecated API for given entry type » à chaque page. | Observé | Mettre à jour l’observateur de performance. |
