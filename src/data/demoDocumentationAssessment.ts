...
const DEFINITIONS: Array<{
  ...
  { id: 'dated_condition_report_dev03', tier: 'P3', label: 'Constat d’état daté', expectedProof: 'Constat d’état daté, accompagné de ses sources.', dependencies: ['DEV-03'] },
  { id: 'dated_sourced_valuation_dev04', tier: 'P3', label: 'Évaluation datée et sourcée', expectedProof: 'Évaluation datée avec ses sources et son auteur.', dependencies: ['DEV-04'] },
...
const criteria: DocumentationCriterionResult[] = DEFINITIONS.map((definition, index) => {
  ...
  return {
    ...
    status: satisfied ? 'proven' : 'missing',
    satisfied,
...
export const DEMO_SUBMARINER_DOCUMENTATION_ASSESSMENT: DocumentationAssessmentProjection = {
  ...
  actions: [
    ...
    },
    {
      cartularyId: DEMO_SUBMARINER_CARTULARY_ID, displayTitle: 'Rolex Submariner 124060 · démonstration fictive',
      collectionId: DEMO_ACCOUNT.collectionId, collectionIds: [DEMO_ACCOUNT.collectionId], targetTier: 'P3', targetTierName: 'Dossier daté',
      criterionId: 'dated_condition_report_dev03', missingCriterion: 'Constat d’état daté', action: 'Faire établir un constat d’état daté.',
      expectedProof: 'Constat d’état daté, accompagné de ses sources.', costCategory: 'time', dependencies: ['DEV-03'],
    ...
    },
    {
      cartularyId: DEMO_SUBMARINER_CARTULARY_ID, displayTitle: 'Rolex Submariner 124060 · démonstration fictive',
      collectionId: DEMO_ACCOUNT.collectionId, collectionIds: [DEMO_ACCOUNT.collectionId], targetTier: 'P3', targetTierName: 'Dossier daté',
      criterionId: 'dated_sourced_valuation_dev04', missingCriterion: 'Évaluation datée et sourcée', action: 'Faire établir une évaluation datée et sourcée.',
      expectedProof: 'Évaluation datée avec ses sources et son auteur.', costCategory: 'time', dependencies: ['DEV-04'],
